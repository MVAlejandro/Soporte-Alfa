...
export async function renderReportTable(ticketsParam = null) {
    ...
    allTickets.sort((a, b) => new Date(a.fecha_creado) - new Date(b.fecha_creado));
    ...
    if (!allTickets || allTickets.length === 0) {
        tbody.innerHTML = `<tr><td class="text-center" colspan="8">No hay tickets registrados para hoy</td></tr>`;
        return;
    }
    ...
    allTickets.forEach(ticket => {
        ...
        `<tr>
            ...
            <td class="ticket-description p-2">${ticket.descripcion}</td>
        </tr>`;
    });
}
